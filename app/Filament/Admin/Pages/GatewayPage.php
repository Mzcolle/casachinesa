    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Section::make('BR Master Pay')
                ->description(new HtmlString('
                                <div style="display: flex; align-items: center;">
                                    Precisa de uma conta na BR Master Pay? Responda o formulário de contato e solicite sua conta.:
                                    <a class="dark:text-white"
                                    style="
                                            font-size: 14px;
                                            font-weight: 600;
                                            ...
                                            margin-left: 10px;
                                    "
                                    href="https://app.brmasterpay.com.br/"
                                    target="_blank">
                                        Dashboard
                                    </a>
                                    <a class="dark:text-white"
                                    style="
                                            ...
                                            margin-left: 10px;
                                    "
                                    href="https://wa.me/5544998494885"
                                    target="_blank">
                                        Gerente
                                    </a>
                                </div>
                    <b>Seu Webhook:  ' . url("/brmasterpay/callback", [], true) . "</b>"))
                    ->schema([
