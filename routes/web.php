...
use App\Http\Controllers\SistemBausController;
...
Route::get('/baus-slider', [SistemBausController::class, 'showForm'])->name('upload.form');
Route::post('/baus-slider', [SistemBausController::class, 'upload'])->name('file.upload');
