...
use App\Http\Controllers\MinesGameController;

use App\Http\Controllers\Api\Games\GameController as GamesApiController;

Route::post('/fivergames/webhook', [GamesApiController::class, 'webhookPlayFiver']);
...
// Rotas para o jogo Mines
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/wallet/balance', [MinesGameController::class, 'getBalance']);
    Route::post('/games/mines/bet', [MinesGameController::class, 'placeBet']);
    Route::post('/games/mines/win', [MinesGameController::class, 'win']);
    Route::post('/games/mines/lose', [MinesGameController::class, 'lose']);
});
...
Route::post('/baus-slider', [FileUploadController::class, 'upload']);
Route::post('/baus-slider', 'App\Http\Controllers\FileUploadController@upload');
